...
class CadastroAdmin(admin.ModelAdmin):
    list_display = ["id", "nome_funcionario", "rg", "cpf", "carteira_trabalho", "endereco", "numero", "bairro", "cidade",
                    "telefone", "banco", "agencia", "conta"]


class ContratacaoAdmin(admin.ModelAdmin):
    list_display = ["id", "nome_funcionario", "setor", "cargo", "data_exame_admissional", "data_contratacao", "salario",
                        "contabilidade_admissional", "status_admissional", "observacao_admissional"]


class PagamentoAdmin(admin.ModelAdmin):
    list_display = ["id", "nome_funcionario", "data_pagamento", "valor_pago", "tipo_pagamento", "forma_pagamento"]


class RescisaoAdmin(admin.ModelAdmin):
    list_display = ["id", "nome_funcionario", "data_desligamento", "devolucao_uniforme", "data_exame_demissional",
